 ...
 *   wsh(sortedmulti(2,[aabbccdd/48'/0'/0'/2']xpub6D.../0/*,[eeff0011/48'/0'/0'/2']xpub6E.../0/*,[11223344/48'/0'/0'/2']xpub6F.../0/*))
 *
 ...
 * or just the receive descriptor and the change one will be auto-generated (/0/* → /1/*).
 */
@Serializable
