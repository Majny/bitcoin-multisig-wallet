...
model \textbf{Trezor One} (první generace s~micro-USB konektorem) mobilní
aplikaci nepodporuje a~lze jej použít pouze s~desktopovou verzí Trezor
Suite, takže pro naši aplikaci není použitelný.
