...
přijetí druhého podpisu detekuje dosažení prahu, finalizuje PSBT (sestaví
witness s~podpisy ve správném pořadí dle BIP-67~\cite{BIP67}) a~provede broadcast.
Úspěch ověřujeme v~Mempool.space, kde u~vstupů vidíme očekávaný witness
