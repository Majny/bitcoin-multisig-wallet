...
// Reads api.gateway.base.url from local.properties (gitignored) and injects
// it into BuildConfig. If missing, falls back to 10.0.2.2 (the emulator's
// alias for the host's localhost), which works against docker compose.
